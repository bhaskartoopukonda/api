...
public class ClientDocument extends AbstractRestAssuredResponse{
	...
	@Description("Verify the upload pdf file functionality of the API on client level")
	@Step("verifies document types")
	@Severity(SeverityLevel.BLOCKER)
	@Test(groups= {"sanity", "smoke","regression" })
	public void verifyPDFuploadDocuments() {
		SoftAssert softassert = new SoftAssert();
		Response rspn =callPOSTMethod1(token,data.uploadFileThroughClient(),path1,fileType1,fileName1,"null",data.clientId(),
				"clientId",data.clientId(),"level","client");
	...
	@Feature("Documents")
	@Stories(value = { @Story(value = "Type of file accept validation")})
	@Description("Verify the upload zip file functionality of the API on client level")
	@Step("verifies document types")
	@Severity(SeverityLevel.BLOCKER)
	@Test(groups= {"sanity", "smoke","regression" })
	public void verifyZIPuploadDocument() {
		...
		Response rspn =callPOSTMethod1(token,data.uploadFileThroughClient(),path2,fileType2,fileName2,"null",data.clientId(),
				"clientId",data.clientId(),"level","client");
		int code =rspn.getStatusCode();
		System.out.println(code);
		softassert.assertEquals(code, STATUS_CODE_201);
	...
	@Feature("Documents")
	@Stories(value = { @Story(value = "Type of file accept validation")})
	@Description("Verify the upload xls file functionality of the API on client level")
	@Step("verifies document types")
	@Severity(SeverityLevel.BLOCKER)
	@Test(groups= {"sanity", "smoke","regression" })
	public void verifyXLSuploadDocument() {
		SoftAssert softassert = new SoftAssert();
		Response rspn =callPOSTMethod1(token,data.uploadFileThroughClient(),path3,fileType3,fileName3,"null",data.clientId(),
				"clientId",data.clientId(),"level","client");
		int code =rspn.getStatusCode();
		System.out.println(code);
		softassert.assertEquals(code, STATUS_CODE_201);
	...
	@Feature("Documents")
	@Stories(value = { @Story(value = "Type of file accept validation")})
	@Description("Verify the upload txt file functionality of the API on client level")
	@Step("verifies document types")
	@Severity(SeverityLevel.BLOCKER)
	@Test(groups= {"sanity", "smoke","regression" })
	public void verifyTXTuploadDocument() {
		SoftAssert softassert = new SoftAssert();
		Response rspn =callPOSTMethod1(token,data.uploadFileThroughClient(),path4,fileType4,fileName4,"null",data.clientId(),
				"clientId",data.clientId(),"level","client");
		int code =rspn.getStatusCode();
		System.out.println(code);
		softassert.assertEquals(code, STATUS_CODE_201);
	...
	@Feature("Documents")
	@Stories(value = { @Story(value = "Type of file accept validation")})
	@Description("Verify the upload docx file functionality of the API on client level")
	@Step("verifies document types")
	@Severity(SeverityLevel.BLOCKER)
	@Test(groups= {"sanity", "smoke","regression" })
	public void verifyDOCXuploadDocument() {
		SoftAssert softassert = new SoftAssert();
		Response rspn = callPOSTMethod1(token,data.uploadFileThroughClient(),path5,fileType5,fileName5,"null",data.clientId(),
				"clientId",data.clientId(),"level","client");
		int code =rspn.getStatusCode();
		System.out.println(code);
		softassert.assertEquals(code, STATUS_CODE_201);
	...
	public void verifyBMPuploadDocument() {
		SoftAssert softassert = new SoftAssert();
		Response rspn =callPOSTMethod1(token,data.uploadFileThroughClient(),path6,fileType6,fileName6,"null",data.clientId(),
				"clientId",data.clientId(),"level","client");
		int code =rspn.getStatusCode();
		System.out.println(code);
		softassert.assertEquals(code, STATUS_CODE_201);
	...
	@Feature("Documents")
	@Stories(value = { @Story(value = "Type of file accept validation")})
	@Description("Verify the upload doc file functionality of the API on client level")
	@Step("verifies document types")
	@Severity(SeverityLevel.BLOCKER)
	@Test(groups= {"sanity", "smoke","regression" })
	public void verifyDOCuploadDocument() {
		SoftAssert softassert = new SoftAssert();
		Response rspn =callPOSTMethod1(token,data.uploadFileThroughClient(),path7,fileType7,fileName7,"null",data.clientId(),
				"clientId",data.clientId(),"level","client");
		int code =rspn.getStatusCode();
		System.out.println(code);
		softassert.assertEquals(code, STATUS_CODE_201);
	...
	@Feature("Documents")
	@Stories(value = { @Story(value = "Type of file accept validation")})
	@Description("Verify the upload jpeg file functionality of the API on client level")
	@Step("verifies document types")
	@Severity(SeverityLevel.BLOCKER)
	@Test(groups= {"sanity", "smoke","regression" })
	public void verifyJPEGuploadDocument() {
		SoftAssert softassert = new SoftAssert();
		Response rspn =callPOSTMethod1(token,data.uploadFileThroughClient(),path8,fileType8,fileName8,"null",data.clientId(),
				"clientId",data.clientId(),"level","client");
		int code =rspn.getStatusCode();
		System.out.println(code);
		softassert.assertEquals(code, STATUS_CODE_201);
	...
	@Feature("Documents")
	@Stories(value = { @Story(value = "Type of file accept validation")})
	@Description("Verify the upload png file functionality of the API on client level")
	@Step("verifies document types")
	@Severity(SeverityLevel.BLOCKER)
	@Test(groups= {"sanity", "smoke","regression" })
	public void verifyPNGuploadDocument() {
		SoftAssert softassert = new SoftAssert();
		Response rspn = callPOSTMethod1(token,data.uploadFileThroughClient(),path9,fileType9,fileName9,"null",data.clientId(),
				"clientId",data.clientId(),"level","client");
		int code =rspn.getStatusCode();
		System.out.println(code);
		softassert.assertEquals(code, STATUS_CODE_201);
	...
	@Feature("Documents")
	@Stories(value = { @Story(value = "Type of file accept validation")})
	@Description("Verify the upload xlsx file functionality of the API on client level")
	@Step("verifies document types")
	@Severity(SeverityLevel.BLOCKER)
	@Test(groups= {"sanity", "smoke","regression" })
	public void verifyXLSXuploadDocument() {
		SoftAssert softassert = new SoftAssert();
		Response rspn =callPOSTMethod1(token,data.uploadFileThroughClient(),path10,fileType10,fileName10,"null",data.clientId(),
				"clientId",data.clientId(),"level","client");
		int code =rspn.getStatusCode();
		System.out.println(code);
		softassert.assertEquals(code, STATUS_CODE_201);
	...
	@Feature("Documents")
	@Stories(value = { @Story(value = "Type of file accept validation")})
	@Description("Verify and validate the document No value with more than 25 charcter invalid and valid character on client level")
	@Step("verifies document types")
	@Severity(SeverityLevel.BLOCKER)
	@Test(dataProviderClass=TestNGDataProvider.class,dataProvider="datafromexcel",groups= {"sanity","smoke","Regression"})
	public void clientDocument(String DocumentNo,String DocumentName,String purpose,String termloanId,String clientId,String StatusCode) {
		SoftAssert softassert = new SoftAssert();
		try {
			Response rspn = callPOSTMethod2(token,data.uploadFileThroughClient(),path10,fileType10,fileName10 ,DocumentNo,DocumentName ,purpose,termloanId,clientId,
					"clientId",data.clientId(),"level","client");
			int code =rspn.getStatusCode();
			System.out.println(code);
