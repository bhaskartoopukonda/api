...
public class PayloadUat extends Payloads{
...
//	        System.out.println("requestBodyForChargeCode "+requestBodyForChargeCode);
	    ...
	    public String getPayloadforPreviewToCheckLoanNumberPositive(String LoanNumber) {
	        String requestBodyForChargeCode="{\r\n" + 
	        		"  \"id\": null,\r\n" + 
	        		"  \"loanType\": {\r\n" + 
	        		"    \"id\": \"ce6801cd-e5e6-11e9-a608-16338cc601b4\",\r\n" + 
	        		"    \"value\": \"term_loan\",\r\n" + 
	        		"    \"display\": \"Term Loan\"\r\n" + 
	        		"  },\r\n" + 
	        		"  \"borrower\": {\r\n" + 
	        		...
	        		"  \"initialPaymentDate\": null,\r\n" + 
	        		"  \"termType\": {\r\n" + 
	        		"    \"id\": \"ce637b56-e5e6-11e9-a608-16338cc601b4\",\r\n" + 
	        		"    \"value\": \"months\",\r\n" + 
	        		"    \"display\": \"Months\"\r\n" + 
	        		"  },\r\n" + 
	        		"  \"terms\": \"5\",\r\n" + 
	        		...
	        		"  \"dailyDivisor\": 365,\r\n" + 
	        		"  \"loanStatus\": {\r\n" + 
	        		"    \"id\": \"bd609ad7-fad8-11e9-a608-16338cc601b4\",\r\n" + 
	        		"    \"displayName\": \"Active\",\r\n" + 
	        		"    \"value\": \"active\"\r\n" + 
	        		"  },\r\n" + 
	        		"  \"paidOffDate\": null,\r\n" + 
...
//	        System.out.println("requestBodyForChargeCode "+requestBodyForChargeCode);
	    ...
	    public String latefee() {
	        String requestBodyForChargeCode="{\r\n" + 
	        		...
	        		"  \"lateFeePercentage\": 0,\r\n" + 
	        		"  \"termLoan\": {\r\n" + 
	        		"    \"id\": \"acb37b38-dd05-4ebf-b0e1-2ea2c9682dbc\"\r\n" + 
	        		"  },\r\n" + 
	        		"  \"pastDueDays\": 10,\r\n" + 
	        		"  \"feeBasedOn\": {\r\n" + 
	        		"    \"id\": \"ce7bec86-e5e6-11e9-a608-16338cc601b4\"\r\n" + 
	        		"  },\r\n" + 
	        		"  \"lateFeeValue\": 500\r\n" + 
	        		"}";
...
//	        System.out.println("requestBodyForChargeCode "+requestBodyForChargeCode);
	    ...
	    public String latefeePUt() {
	        String requestBodyForChargeCode="{\r\n" + 
	        		"  \"id\": \"78c6313f-a631-49eb-bc27-c52f5ab816fe\",\r\n" + 
	        		"  \"lateFeePercentage\": 0,\r\n" + 
	        		"  \"termLoan\": {\r\n" + 
	        		"    \"id\": \"acb37b38-dd05-4ebf-b0e1-2ea2c9682dbc\"\r\n" + 
	        		"  },\r\n" + 
...
//	        System.out.println("requestBodyForChargeCode "+requestBodyForChargeCode);
	    ...
	    public String   getPayloadforChargeTemplatePost() {
	        String requestBodyForChargeCode="[\r\n" + 
	        		"  {\r\n" + 
	        		"    \"termLoan\": {\r\n" + 
	        		"      \"id\": \"acb37b38-dd05-4ebf-b0e1-2ea2c9682dbc\"\r\n" + 
	        		"    },\r\n" + 
	        		"    \"chargeCode\": {\r\n" + 
	        		"      \"id\": \"4809de2e-b243-408d-9262-3e9d7a499e75\"\r\n" + 
	        		"    },\r\n" + 
	        		"    \"natSign\": \"+\",\r\n" + 
	        		"    \"frequency\": \"manual\",\r\n" + 
	        		"    \"chargeType\": {\r\n" + 
...
//	        System.out.println("requestBodyForChargeCode "+requestBodyForChargeCode);
	    ...
	    public String  getPayloadforChargeTemplatePut() {
	        String requestBodyForChargeCode="  {\r\n" + 
	        		"    \"termLoan\": {\r\n" + 
	        		"      \"id\": \"acb37b38-dd05-4ebf-b0e1-2ea2c9682dbc\"\r\n" + 
	        		"    },\r\n" + 
	        		...
	        		"    },\r\n" + 
	        		"    \"value\": \""+getValue()+"\",\r\n" + 
	        		"    \"id\": \"4996ce26-4246-46da-a05a-0d7b11524173\"\r\n" + 
	        		"  }\r\n" + 
	        		"]";
...
//	        System.out.println("requestBodyForChargeCode "+requestBodyForChargeCode);
	    ...
	    public String   getPayloadforChargeTemplatePUTFloat() {
	        String requestBodyForChargeCode="[\r\n" + 
	        		"  {\r\n" + 
	        		"    \"termLoan\": {\r\n" + 
	        		"      \"id\": \"acb37b38-dd05-4ebf-b0e1-2ea2c9682dbc\"\r\n" + 
...
//	        System.out.println("requestBodyForChargeCode "+requestBodyForChargeCode);
	    ...
	    public String  getPayloadforchargecodes() {
	        String requestBodyForChargeCode="{\r\n" + 
	        		...
	        		"  \"transactionCode\": \""+getTransactionCode()+"\",\r\n" + 
	        		"  \"natSign\": {\r\n" + 
	        		"    \"id\": \"ce71bf43-e5e6-11e9-a608-16338cc601b4\",\r\n" + 
	        		"    \"value\": \"+\",\r\n" + 
	        		"    \"displayName\": \"Plus\"\r\n" + 
	        		"  },\r\n" + 
	        		"  \"frequency\": {\r\n" + 
	        		"    \"id\": \"ce6ca0b1-e5e6-11e9-a608-16338cc601b4\",\r\n" + 
	        		"    \"value\": \"manual\",\r\n" + 
	        		"    \"displayName\": \"Manual\"\r\n" + 
	        		"  },\r\n" + 
	        		"  \"chargeType\": {\r\n" + 
	        		...
	        		"  },\r\n" + 
	        		"  \"postingType\": {\r\n" + 
	        		"    \"id\": \"ce770a01-e5e6-11e9-a608-16338cc601b4\",\r\n" + 
	        		"    \"value\": \"in_bal\",\r\n" + 
	        		"    \"displayName\": \"In Balance\"\r\n" + 
	        		"  },\r\n" + 
	        		"  \"value\": \"3\",\r\n" + 
...
//	        System.out.println("requestBodyForChargeCode "+requestBodyForChargeCode);
	    ...
	    public String  getPayloadforManualFeePost() {
	        String requestBodyForChargeCode="[\r\n" + 
	        		"   {\r\n" + 
	        		"      \"id\":\"9010ac8b-7cff-4e03-87a9-6d1830fd074a\",\r\n" + 
	        		"      \"termLoan\":{\r\n" + 
	        		"         \"id\":\"acb37b38-dd05-4ebf-b0e1-2ea2c9682dbc\",\r\n" + 
	        		"         \"loanNumber\":\"Loan14\",\r\n" + 
	        		"         \"loanName\":\"Loan14 : Loan\",\r\n" + 
	        		...
	        		"         \"totalInterest\":10,\r\n" + 
	        		"         \"rateAdjustment\":0,\r\n" + 
	        		"         \"revisedInterestRateEffectiveDate\":\"08/12/2020\",\r\n" + 
	        		"         \"interestRateType\":\"fixed\",\r\n" + 
	        		"         \"interestRateCode\":0,\r\n" + 
	        		"         \"divisor\":12,\r\n" + 
	        		"         \"termType\":{\r\n" + 
	        		...
	        		"         },\r\n" + 
	        		"         \"terms\":12,\r\n" + 
	        		"         \"originationDate\":\"08/12/2020\",\r\n" + 
	        		"         \"disbursementDate\":null,\r\n" + 
	        		"         \"maturityDate\":\"08/12/2021\",\r\n" + 
	        		"         \"initialPaymentDate\":\"09/12/2020\",\r\n" + 
	        		"         \"includeLoanBalanceInReserve\":false,\r\n" + 
	        		"         \"borrower\":{\r\n" + 
	        		"            \"id\":739,\r\n" + 
	        		"            \"name\":\"MAHESHQA\",\r\n" + 
		...
		public String getCommitRequestBodyOfLoan(String responseOfPreview,String LoanNumber,String LoanName,String PrincipalAmount,String Term,String Termtype,String	Intrest,String Originationdate,String InitialPaymentdate,String Disburnsmentdate,String	interestRateType,String	rateAdjustment,String amortizationType,String	MaturityDate)			
	     {
			String rqst ="{\r\n" + 
					...
					"  \"initialPaymentDate\": \""+InitialPaymentdate+"\",\r\n" + 
					"  \"termType\": {\r\n" + 
					"    \"id\": \"ce61801e-e5e6-11e9-a608-16338cc601b4\",\r\n" + 
					"    \"value\": \""+Termtype+"\",\r\n" + 
					"    \"display\": \""+Termtype+"\"\r\n" + 
					"  },\r\n" + 
					"  \"terms\": \""+Term+"\",\r\n" + 
...
//		        System.out.println("requestBodyForChargeCode "+requestBodyForChargeCode);
		 ...
		 public String createNoteForFollowOverDueOrFollowPeriod() {
			 String createNoteForFollowOverDueOrFollowPeriod ="{\r\n" + 
			 		...
			 		"      {\r\n" + 
			 		"         \"period\":1,\r\n" + 
			 		"         \"termLoanId\":\"acb37b38-dd05-4ebf-b0e1-2ea2c9682dbc\"\r\n" + 
			 		"      }\r\n" + 
			 		"   ]\r\n" + 
			 		"}";
		 ...
		 public String smsNotificationPayload(String templateId) {
			 String smsNotificationPayload="{\r\n" + 
			 		"  \"templateId\": \""+templateId+"\",\r\n" + 
			 		"  \"notificationType\": \"text\",\r\n" + 
			 		"  \"notifyDetails\": [\r\n" + 
			 		"    {\r\n" + 
			 		"      \"termLoanId\": \""+templateId+"\",\r\n" + 
			 		"      \"period\": \"1\"\r\n" + 
			 		"    }\r\n" + 
			 		"  ]\r\n" + 
			 		"}";
